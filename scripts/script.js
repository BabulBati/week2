...
// Contact Form
const contactForm = document.getElementById('contactForm'); // Assuming the form has an ID
const messageDiv = document.getElementById('from-messageDiv'); // Assuming a div for feedback
if (contactForm && messageDiv) {
	contactForm.addEventListener('submit', function (event) {
		...
		const emailInput = document.getElementById('yemail').value;
		const emailMsg = document.getElementById('msg').value;
		if (nameInput === '' || emailInput === '' || emailMsg === '') {
